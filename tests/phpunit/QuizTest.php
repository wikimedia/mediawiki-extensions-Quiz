...
class QuizTest extends QuizTestCase {
	...
	public static function provideGetSettingsTable() {
		return [
			...
			[ [ '0', '0', 'NA', '1', '3', '-1', '1', '4' ],
			 "\t" . '<tr>' . "\n\t\t" . '<td><label for="addedPoints0">' .
			 'Points added for a correct answer:</label></td>' .
			 "\n\t\t" . '<td><input class="numerical" type="number" ' .
			 'name="addedPoints" id="addedPoints0" value="3"/>&#160;&#160;</td>' . "\n\t" .
			 '</tr>' . "\n\t" . '<tr>' . "\n\t\t" . '<td><label for="cutoffPoints0">'
			 . 'Point for an incorrect answer:</label></td>'
			 . "\n\t\t" . '<td><input class="numerical" type="number" ' .
			 'name="cutoffPoints" id="cutoffPoints0" value="-1"/></td>' . "\n\t" .
			 '</tr>' . "\n\t" . '<tr>' . "\n\t\t" . '<td><label for="ignoringCoef0">'
			 . 'Ignore the questions&#039; coefficients:</label></td>'
			 . "\n\t\t" . '<td><input type="checkbox" name="ignoringCoef" id="ignoringCoef0" ' .
			 'checked="checked"/></td>' . "\n\t" .
			 '</tr>' . "\n\t" . '<tr>' . "\n\t\t\t\t\t"
